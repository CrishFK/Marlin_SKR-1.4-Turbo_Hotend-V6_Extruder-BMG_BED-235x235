...
#define STRING_CONFIG_H_AUTHOR "(Matosantos, config_CrishFK)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SKR 1.4 TURBO V6 BMG BLTOUCH By CrishFK"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  19.96,  19.96 }
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 70.86
  #define DEFAULT_bedKi 13.81
  #define DEFAULT_bedKd 242.35
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -15, -3 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 37, 50, 30, 10 } // (mm) Left, Front, Right, Back insets
